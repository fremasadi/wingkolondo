<div class="row">
    ...
    <div class="col-md-3 mb-3">
        ...
        <input type="number" name="harga" min="0" class="form-control" value="{{ old('harga', $produk->harga ?? 0) }}"
            required>
    </div>
</div>
...
@foreach($bahanBakus as $bahan)
    <div class="row align-items-center mb-2">
        ...
        <div class="col-md-4">
            <input type="number" step="0.01" name="bahan[{{ $bahan->id }}]" class="form-control" placeholder="Qty per pcs"
